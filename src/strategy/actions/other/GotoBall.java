...
//            this.robot.ACTION_CONTROLLER.setAction(new Demo(robot, 150, 255, 255, 150));
            ((FourWheelHolonomicRobotPort)this.robot.port).fourWheelHolonomicMotion(150,255,255,150);
            System.out.println("moving forward now! ");
            ((Fred)this.robot).GRABBER_CONTROLLER.grab(1, 1000);
            ((Fred)this.robot).GRABBER_CONTROLLER.grab(2, 500);
        } else if (newState == 4) {
...
//        }
            ...
            System.out.println("too close go back to state 1!!!!");
            this.enterState(1);
        }
